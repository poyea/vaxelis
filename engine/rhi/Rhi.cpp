...
std::string_view to_string(RhiError e) {
    switch (e) {
        case RhiError::BackendUnavailable:  return "BackendUnavailable";
        case RhiError::InvalidHandle:       return "InvalidHandle";
        case RhiError::ShaderCompileFailed: return "ShaderCompileFailed";
        case RhiError::ProgramLinkFailed:   return "ProgramLinkFailed";
        case RhiError::UnsupportedFormat:   return "UnsupportedFormat";
        case RhiError::OutOfMemory:         return "OutOfMemory";
    }
    std::unreachable();
}
